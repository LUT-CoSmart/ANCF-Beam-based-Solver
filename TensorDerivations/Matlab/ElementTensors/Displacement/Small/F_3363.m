...
t41 = (W.*t15.*u8.*xi)./4.0;
t42 = (W.*t15.*u9.*xi)./4.0;
t65 = (H.*W.*eta.*t5.*u52.*xi)./8.0;
t66 = (H.*W.*eta.*t5.*u53.*xi)./8.0;
t67 = (H.*W.*eta.*t5.*u54.*xi)./8.0;
t68 = (H.*W.*t5.*u52.*xi.*zeta)./8.0;
t69 = (H.*W.*t5.*u53.*xi.*zeta)./8.0;
t70 = (H.*W.*t5.*u54.*xi.*zeta)./8.0;
t109 = (H.*W.*eta.*t15.*u16.*xi)./8.0;
t110 = (H.*W.*eta.*t15.*u17.*xi)./8.0;
t111 = (H.*W.*eta.*t15.*u18.*xi)./8.0;
t112 = (eta.*t2.*t5.*u46.*xi)./8.0;
t113 = (eta.*t2.*t5.*u47.*xi)./8.0;
t114 = (eta.*t2.*t5.*u48.*xi)./8.0;
t115 = (H.*W.*t15.*u16.*xi.*zeta)./8.0;
t116 = (H.*W.*t15.*u17.*xi.*zeta)./8.0;
t117 = (H.*W.*t15.*u18.*xi.*zeta)./8.0;
t118 = (t3.*t5.*u49.*xi.*zeta)./8.0;
t119 = (t3.*t5.*u50.*xi.*zeta)./8.0;
t120 = (t3.*t5.*u51.*xi.*zeta)./8.0;
t182 = (eta.*t2.*t15.*u10.*xi)./8.0;
t183 = (eta.*t2.*t15.*u11.*xi)./8.0;
t184 = (eta.*t2.*t15.*u12.*xi)./8.0;
t208 = (t3.*t15.*u13.*xi.*zeta)./8.0;
t209 = (t3.*t15.*u14.*xi.*zeta)./8.0;
t210 = (t3.*t15.*u15.*xi.*zeta)./8.0;
t33 = t21.*xi;
t34 = t23.*xi;
t35 = t24.*xi;
t36 = t26.*xi;
...
t85 = t6.*t24;
t86 = t6.*t26;
t103 = (H.*W.*eta.*t17.*u34)./4.0;
t104 = (H.*W.*eta.*t17.*u35)./4.0;
t105 = (H.*W.*eta.*t17.*u36)./4.0;
t106 = (H.*W.*t17.*u34.*zeta)./4.0;
t107 = (H.*W.*t17.*u35.*zeta)./4.0;
t108 = (H.*W.*t17.*u36.*zeta)./4.0;
t130 = q02.*t22.*xi.*8.0;
t132 = q03.*t22.*xi.*8.0;
t133 = q08.*t22.*xi.*8.0;
t134 = q09.*t22.*xi.*8.0;
...
t154 = (eta.*t2.*t17.*u28)./4.0;
t155 = (eta.*t2.*t17.*u29)./4.0;
t156 = (eta.*t2.*t17.*u30)./4.0;
t164 = q02.*t7.*t21.*4.0;
t168 = q03.*t7.*t21.*4.0;
t169 = q02.*t7.*t23.*4.0;
t171 = q03.*t7.*t23.*4.0;
...
t201 = q08.*t7.*t26.*4.0;
t203 = q09.*t7.*t26.*4.0;
t205 = (t3.*t17.*u31.*zeta)./4.0;
t206 = (t3.*t17.*u32.*zeta)./4.0;
t207 = (t3.*t17.*u33.*zeta)./4.0;
t219 = t6.*t22.*-2.0;
t220 = t6.*t25.*-2.0;
t238 = q02.*t7.*t22.*8.0;
t239 = q03.*t7.*t22.*8.0;
...
t971 = 1.0./t970;
t972 = 1.0./t969;
et1 = (t15.*u1)./2.0+(t5.*u37)./2.0+(u1.*xi)./2.0-u19.*xi.*2.0+(u37.*xi)./2.0+(W.*t15.*u7.*zeta)./4.0+(W.*t5.*u43.*zeta)./4.0+(W.*u7.*xi.*zeta)./4.0-W.*u25.*xi.*zeta+(W.*u43.*xi.*zeta)./4.0+(t2.*t4.*t15.*u10)./1.6e+1+(t3.*t10.*t15.*u13)./1.6e+1+(t2.*t4.*t5.*u46)./1.6e+1+(t3.*t5.*t10.*u49)./1.6e+1+(t2.*t4.*u10.*xi)./1.6e+1+(t3.*t10.*u13.*xi)./1.6e+1-(t2.*t4.*u28.*xi)./4.0-(t3.*t10.*u31.*xi)./4.0+(t2.*t4.*u46.*xi)./1.6e+1+(t3.*t10.*u49.*xi)./1.6e+1+(H.*eta.*t15.*u4)./4.0+(H.*eta.*t5.*u40)./4.0+(H.*eta.*u4.*xi)./4.0-H.*eta.*u22.*xi+(H.*eta.*u40.*xi)./4.0;
et2 = (H.*W.*eta.*t15.*u16.*zeta)./8.0+(H.*W.*eta.*t5.*u52.*zeta)./8.0+(H.*W.*eta.*u16.*xi.*zeta)./8.0-(H.*W.*eta.*u34.*xi.*zeta)./2.0+(H.*W.*eta.*u52.*xi.*zeta)./8.0;
et3 = (t15.*u2)./2.0+(t5.*u38)./2.0+(u2.*xi)./2.0-u20.*xi.*2.0+(u38.*xi)./2.0+(W.*t15.*u8.*zeta)./4.0+(W.*t5.*u44.*zeta)./4.0+(W.*u8.*xi.*zeta)./4.0-W.*u26.*xi.*zeta+(W.*u44.*xi.*zeta)./4.0+(t2.*t4.*t15.*u11)./1.6e+1+(t3.*t10.*t15.*u14)./1.6e+1+(t2.*t4.*t5.*u47)./1.6e+1+(t3.*t5.*t10.*u50)./1.6e+1+(t2.*t4.*u11.*xi)./1.6e+1+(t3.*t10.*u14.*xi)./1.6e+1-(t2.*t4.*u29.*xi)./4.0-(t3.*t10.*u32.*xi)./4.0+(t2.*t4.*u47.*xi)./1.6e+1+(t3.*t10.*u50.*xi)./1.6e+1+(H.*eta.*t15.*u5)./4.0+(H.*eta.*t5.*u41)./4.0+(H.*eta.*u5.*xi)./4.0-H.*eta.*u23.*xi+(H.*eta.*u41.*xi)./4.0;
et4 = (H.*W.*eta.*t15.*u17.*zeta)./8.0+(H.*W.*eta.*t5.*u53.*zeta)./8.0+(H.*W.*eta.*u17.*xi.*zeta)./8.0-(H.*W.*eta.*u35.*xi.*zeta)./2.0+(H.*W.*eta.*u53.*xi.*zeta)./8.0;
et5 = (t15.*u3)./2.0+(t5.*u39)./2.0+(u3.*xi)./2.0-u21.*xi.*2.0+(u39.*xi)./2.0+(W.*t15.*u9.*zeta)./4.0+(W.*t5.*u45.*zeta)./4.0+(W.*u9.*xi.*zeta)./4.0-W.*u27.*xi.*zeta+(W.*u45.*xi.*zeta)./4.0+(t2.*t4.*t15.*u12)./1.6e+1+(t3.*t10.*t15.*u15)./1.6e+1+(t2.*t4.*t5.*u48)./1.6e+1+(t3.*t5.*t10.*u51)./1.6e+1+(t2.*t4.*u12.*xi)./1.6e+1+(t3.*t10.*u15.*xi)./1.6e+1-(t2.*t4.*u30.*xi)./4.0-(t3.*t10.*u33.*xi)./4.0+(t2.*t4.*u48.*xi)./1.6e+1+(t3.*t10.*u51.*xi)./1.6e+1+(H.*eta.*t15.*u6)./4.0+(H.*eta.*t5.*u42)./4.0+(H.*eta.*u6.*xi)./4.0-H.*eta.*u24.*xi+(H.*eta.*u42.*xi)./4.0;
et6 = (H.*W.*eta.*t15.*u18.*zeta)./8.0+(H.*W.*eta.*t5.*u54.*zeta)./8.0+(H.*W.*eta.*u18.*xi.*zeta)./8.0-(H.*W.*eta.*u36.*xi.*zeta)./2.0+(H.*W.*eta.*u54.*xi.*zeta)./8.0;
