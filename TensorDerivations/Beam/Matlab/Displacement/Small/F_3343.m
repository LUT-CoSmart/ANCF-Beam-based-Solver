...
t943 = 1.0./t942;
t944 = 1.0./t941;
mt1 = [t560.*(u1.*(-1.0./2.0)+u25./2.0+u1.*xi-u13.*xi.*2.0+u25.*xi-(H.*eta.*u4)./4.0+(H.*eta.*u28)./4.0-(W.*u7.*zeta)./4.0+(W.*u31.*zeta)./4.0+(W.*u7.*xi.*zeta)./2.0-W.*u19.*xi.*zeta+(W.*u31.*xi.*zeta)./2.0+(H.*eta.*u4.*xi)./2.0-H.*eta.*u16.*xi+(H.*eta.*u28.*xi)./2.0-(H.*W.*eta.*u10.*zeta)./8.0+(H.*W.*eta.*u34.*zeta)./8.0+(H.*W.*eta.*u10.*xi.*zeta)./4.0-(H.*W.*eta.*u22.*xi.*zeta)./2.0+(H.*W.*eta.*u34.*xi.*zeta)./4.0).*2.0-t927.*t940.*t944.*2.0-t931.*t939.*t943.*2.0+1.0];
mt2 = [t560.*(u2.*(-1.0./2.0)+u26./2.0+u2.*xi-u14.*xi.*2.0+u26.*xi-(H.*eta.*u5)./4.0+(H.*eta.*u29)./4.0-(W.*u8.*zeta)./4.0+(W.*u32.*zeta)./4.0+(W.*u8.*xi.*zeta)./2.0-W.*u20.*xi.*zeta+(W.*u32.*xi.*zeta)./2.0+(H.*eta.*u5.*xi)./2.0-H.*eta.*u17.*xi+(H.*eta.*u29.*xi)./2.0-(H.*W.*eta.*u11.*zeta)./8.0+(H.*W.*eta.*u35.*zeta)./8.0+(H.*W.*eta.*u11.*xi.*zeta)./4.0-(H.*W.*eta.*u23.*xi.*zeta)./2.0+(H.*W.*eta.*u35.*xi.*zeta)./4.0).*2.0-t928.*t940.*t944.*2.0-t932.*t939.*t943.*2.0];
mt3 = [t560.*(u3.*(-1.0./2.0)+u27./2.0+u3.*xi-u15.*xi.*2.0+u27.*xi-(H.*eta.*u6)./4.0+(H.*eta.*u30)./4.0-(W.*u9.*zeta)./4.0+(W.*u33.*zeta)./4.0+(W.*u9.*xi.*zeta)./2.0-W.*u21.*xi.*zeta+(W.*u33.*xi.*zeta)./2.0+(H.*eta.*u6.*xi)./2.0-H.*eta.*u18.*xi+(H.*eta.*u30.*xi)./2.0-(H.*W.*eta.*u12.*zeta)./8.0+(H.*W.*eta.*u36.*zeta)./8.0+(H.*W.*eta.*u12.*xi.*zeta)./4.0-(H.*W.*eta.*u24.*xi.*zeta)./2.0+(H.*W.*eta.*u36.*xi.*zeta)./4.0).*2.0-t929.*t940.*t944.*2.0-t933.*t939.*t943.*2.0,t927.*t934.*t937.*-4.0+t930.*t931.*t938.*4.0,t928.*t934.*t937.*-4.0+t930.*t932.*t938.*4.0+1.0];
mt4 = [t929.*t934.*t937.*-4.0+t930.*t933.*t938.*4.0,t927.*t930.*t937.*4.0+t931.*t934.*t938.*4.0,t928.*t930.*t937.*4.0+t932.*t934.*t938.*4.0,t929.*t930.*t937.*4.0+t933.*t934.*t938.*4.0+1.0];
