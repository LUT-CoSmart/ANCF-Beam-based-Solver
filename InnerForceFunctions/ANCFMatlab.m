function [K_loc,Fe] = ANCFMatlab(MaterialName,K_loc,Fe0,uk,qk,qk0,phik,Dvec,Element,ElemDofs,PosDofs,Gint,Nint,detF0,h)
I_vec=Fe0;              % initialization of the disturbance vector
Fe=Fe_fun(MaterialName,Fe0,uk,qk,qk0,phik,Dvec,Element,ElemDofs,PosDofs,Gint,Nint,detF0);   
for jj = 1:ElemDofs    % cycle over all 
    ...
    Feh=Fe_fun(MaterialName,Fe0,ukh,qkh,qk0,phik,Dvec,Element,ElemDofs,PosDofs,Gint,Nint,detF0);   
    K_loc(:,jj)=(Fe-Feh)/h; 
    I_vec(jj)=0;
end    
