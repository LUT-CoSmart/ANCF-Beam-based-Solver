function [K,ff,Fext]=Kt(q,q0,q0f,u,phim,Phim,F,xloc,nx,nn,nl,MaterialName,Fibers,Dvec,fac,detF0,Gint,Nint,sol_acegen,Element,ElemDofs,DofsAtNode,PosDofs,h)
...
for ii = 1:nl
    ...
    if sol_acegen == false        
        ...
        [K_loc,Fe] = ANCFAceGen(MaterialName,K_loc,Fe,uk,qk0,qk0f,Dvec,Element,DofsAtNode,Gint,Nint,fac);
    end       
    for jj = 1:ElemDofs
