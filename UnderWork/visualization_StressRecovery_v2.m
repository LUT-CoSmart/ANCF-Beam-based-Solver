function visualization_StressRecovery_v2(Body,Show,name)
    ...
    if Show 
        ...
        Recovery_S1 = Body.Recovery_S1;
        Recovery_S2 = Body.Recovery_S2;
        ...
        for k = 1:size(faces,1)  
            ...
            Recovery_S1_k = Recovery_S1(xloc(Element,:));
            Recovery_S2_k = Recovery_S2(xloc(Element,:));
            
           
            for ii = 1:n          

                Stress_S1 = Shape(Xi_points(ii,1),Xi_points(ii,2),Xi_points(ii,3)) * Recovery_S1_k;
                Stress_S2 = Shape(Xi_points(ii,1),Xi_points(ii,2),Xi_points(ii,3)) * Recovery_S2_k;
        ...
        title([name ' stress via N recovery']);
